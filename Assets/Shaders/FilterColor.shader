...
Shader "MyShader/FilterfColor" {
	Properties{
		...
		_FilterfColor2("Ridof2 (RGB)",Color) = (1,1,1,1)
	}
		SubShader{
			...
			pass
			{
				...
				float4 fragment_convert(Inputfragment o) : COLOR
				{
					...
					if ((c.r >= _FilterfColor.r && c.r <= _FilterfColor2.r) && (c.g >= _FilterfColor.g && c.g <= _FilterfColor2.g) && (c.b >= _FilterfColor.b && c.b <= _FilterfColor2.b))
						c.a = 0;
					return c;
				}
