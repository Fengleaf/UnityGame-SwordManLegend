...
- Dome: Texture maps such that the center of the texture is the top of the sky sphere, and the edges of the circle are the horizon.
...
- Fish Eye 360: Maps the fish eye to the entire sky sphere. There is a slight distortion at one end of the sky sphere so this also is not suitable for 360 degree viewing.

Sky sphere also includes a day night cycle, along with time of day calculator. See WeatherMakerDayNightCycleScript.cs. Enable the 'DayNightCycle' game object to turn this on.
...
Orthographic Size
--------------------------------------------------
For 2D Weather Maker, clouds and lightning made need a little tweaking, depending on your orthographic size. Please be sure to set the cloud anchor offset along with the lightning trunk width and light range to appropriate values for your orthographic size.
...
- Fish Eye 360 has some distortion at the side pole of the sphere. I have as of yet been unable to fix this. I welcome suggestions of feedback on how to fix this.
